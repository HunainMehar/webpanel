        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-8 w-8" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg" alt="Workflow"></img>
            </div>
      ...
      <form class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div class=" shadow-sm space-y-3">
          <div >
            ...
            <input id="title" name="title" type="title"  required class="appearance-none  relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Title">
          </input>
          </div>
        <div >
          <label for="description" class=" text-gray-900">Description</label>
          <textarea id="description" cols="20" rows="5" placeholder="write here.." class="w-full font-serif  p-4 text-gray-600 bg-indigo-50 outline-none rounded-md"></textarea>
        <label class="inline-block mb-2 text-gray-500">File Upload</label>
          <div >
            <label for="title" class="sr-only ">Price</label>
            <input id="Price" name="Price" type="Price"  required class="appearance-none  relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none  mb-3 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Price">
          </input>
          </div>
            <div class="flex items-center justify-center w-full">
                <label
                    class="flex flex-col w-full h-32 border-4 border-grey-500 border-dashed hover:bg-gray-100 hover:border-gray-300">
